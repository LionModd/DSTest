...
Using these three components you can craft some simple and even complex apps. Below is a basic example.

```{r, echo = FALSE}
shinyAppDir("C:/Users/DomLaptop/Desktop/dstest/BasicShinyApp")
```
...
Below is a dashboard that has two tabs with basic plots and functions.
...
```{r, echo = FALSE}
shinyAppDir("C:/Users/DomLaptop/Desktop/dstest/BasicShinyApp/dashboard")
```
